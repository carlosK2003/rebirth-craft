...
const products = [
  { title: "Pisos & Assoalhos", description: "Pisos maciços e estruturados em madeiras nobres nacionais e importadas para ambientes sofisticados.", image: pisosImg, alt: "Piso de madeira nobre brasileira", link: "/pisos-e-assoalhos", cta: "Ver detalhes" }, & Assoalhos", description: "Pisos maciços e estruturados em madeiras nobres nacionais e importadas para ambientes sofisticados.", image: pisosImg, alt: "Piso de madeira nobre brasileira", link: "/pisos-e-assoalhos", cta: "Ver detalhes" }, nacionais e importadas para ambientes sofisticados.", image: pisosImg, alt: "Piso de madeira nobre brasileira", link: "/pisos-e-assoalhos", cta: "Ver detalhes" },
